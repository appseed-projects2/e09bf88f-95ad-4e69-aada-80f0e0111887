...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-07 09:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e09bf88f-95ad-4e69-aada-80f0e0111887.git
$ cd e09bf88f-95ad-4e69-aada-80f0e0111887
```
